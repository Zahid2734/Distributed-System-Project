...
#Server_Directory =/home/zahid/Server Client Project/Multi_Client_Server/  #For linux
# Server_Directory = "F:\ALL THESIS\Server Client Project\Multi_Client_Server" #For windows
